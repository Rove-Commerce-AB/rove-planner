...
type Props = {
  ...
  /** Optional: override avatar container (e.g. wider when editing logo URL) */
 ...
 */
const defaultAvatarContainerClass =
  "flex h-14 w-14 flex-shrink-0 items-center justify-center overflow-hidden rounded-full bg-bg-muted text-xl font-semibold text-text-primary";
  ...
  return (
    ...
    >
      ...
      <div className="flex min-w-0 items-center gap-4">
        <div
          className={
            avatarContainerClassName != null && avatarContainerClassName !== ""
              ? avatarContainerClassName
              : defaultAvatarContainerClass
          }
        >
          {avatar}
        </div>
        ...
        {action != null && <div className="flex flex-shrink-0">{action}</div>}
      </div>
    </header>
  );
}
