  ...
  return (
    ...
    >
      <div className="flex min-w-0 flex-1 items-center gap-4">
        <Link
          href={backHref}
          className="flex flex-shrink-0 items-center justify-center rounded-lg border border-border bg-bg-default p-2 text-text-primary opacity-80 transition-opacity hover:opacity-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-signal focus-visible:ring-offset-2"
